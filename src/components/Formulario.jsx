...
const Formulario = ({pacientes,setPacientes,paciente,setPaciente}) => {
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mr-3">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 ml-7 mb-10">
        ...
        <div className="mb-5">
          ...
          <label htmlFor="alta" className="block text-gray-700 uppercase font-bold">Fecha de alta
          </label>
        ...
        <div className="mb-5">
          ...
          <textarea
            id="sintomas"
            placeholder="Describe los síntomas" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
            value={sintomas}
